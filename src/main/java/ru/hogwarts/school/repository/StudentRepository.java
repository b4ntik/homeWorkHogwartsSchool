...
public interface StudentRepository extends JpaRepository<Student, Long> {
    ...
    @Query(value = "SELECT count(*) as countStudents FROM student", nativeQuery = true)
    int findCountStudents();

    @Query(value = "SELECT AVG(age) as AverageAgeOfStudent FROM student", nativeQuery = true)
    int findAverageAgeOfStudents();
